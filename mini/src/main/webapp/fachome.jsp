...
<section class="page-section portfolio bg-primary" id="portfolio">
    <div class="container">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-white mb-5" style="margin-top: 30px;">YOUR SUBJECTS</h2>
        <!-- Icon Divider-->
...
<div class="col-md-6 col-lg-4 mb-5">
    <a href="subupdate.jsp">
        <div class="portfolio-item mx-auto text-white" style="transform: none;">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-2 text-white" style="margin-top: 20px;">ADV JAVA</h2>
        </div>
    </a>
</div>
...
<div class="col-md-6 col-lg-4 mb-5">
    <a href="subupdate.jsp">
        <div class="portfolio-item mx-auto text-white" style="transform: none;">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-2 text-white" style="margin-top: 20px;">TBW</h2>
        </div>
    </a>
</div>
